...
X_data = np.loadtxt('./data/dacon/comp3/KAERI_dataset/train_features.csv',skiprows=1,delimiter=',')
X_data = X_data[:,1:]
print(X_data.shape)
     
    
Y_data = np.loadtxt('./data/dacon/comp3/KAERI_dataset/train_target.csv',skiprows=1,delimiter=',')
Y_data = Y_data[:,1:]
print(Y_data.shape)
...
X_data_test = np.loadtxt('./data/dacon/comp3/KAERI_dataset/test_features.csv',skiprows=1,delimiter=',')
...
submit = pd.read_csv('./data/dacon/comp3/KAERI_dataset/sample_submission.csv')
