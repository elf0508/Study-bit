...
#1. data
train = pd.read_csv('./dacon/comp1/train.csv', index_col= 0 , header = 0)
test = pd.read_csv('./dacon/comp1/test.csv', index_col= 0 , header = 0)
submission = pd.read_csv('./dacon/comp1/sample_submission.csv', index_col= 0 , header = 0)
