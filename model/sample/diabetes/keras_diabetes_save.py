...
modelpath = './model/sample/diabetes/diabetes_checkpoint-{epoch:02d}-{val_loss:.4f}.hdf5'
...
# 저장
model.save('./model/sample/diabetes/diabetes_model_save.h5')     # 훈련아래

model.save_weights('./model/sample/diabetes/diabetes_model_save_weight.h5')  # 훈련아래
...
# loss:  2716.658518587605
# mse:  2716.658447265625
# RMSE:  52.12157463882267
# R2:  0.48877597421218577