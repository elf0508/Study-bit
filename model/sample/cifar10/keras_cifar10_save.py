...
modelpath = './model/sample/cifar10/cifar10_checkpoint-{epoch:02d}-{val_loss:.4f}.hdf5'
...
# 저장
model.save('./model/sample/cifar10/cifar10_model_save.h5')     # 훈련아래

model.save_weights('./model/sample/cifar10/cifar10_model_save_weight.h5')  # 훈련아래
...
# loss : 1.8306700832366944
# acc : 0.3702999949455261