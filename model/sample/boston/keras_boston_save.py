...
modelpath = './model/sample/boston/boston_checkpoint-{epoch:02d}-{val_loss:.4f}.hdf5'
...
model.fit(x_train, y_train,
          ...
          callbacks=[es, cp, tb_hist,checkpoint])


# 저장
model.save('./model/sample/boston/boston_model_save.h5')     # 훈련아래

model.save_weights('./model/sample/boston/boston_model_save_weight.h5')  # 훈련아래
...
'''
RMSE :  6.52959028452642
R2 :  0.4899012807538292
'''