...
# Checkpoint
modelpath = './model/sample/iris/iris_checkpoint-{epoch:02d}-{val_loss:.4f}.hdf5'
...
hist = model.fit(x_train, y_train, epochs =100, batch_size= 64,
                ...
                callbacks = [es, ckecpoint])


# 저장
model.save('./model/sample/iris/iris_save_model_save.h5')     # 훈련아래

model.save_weights('./model/sample/iris/iris_save_model_save_weight.h5')  # 훈련아래
