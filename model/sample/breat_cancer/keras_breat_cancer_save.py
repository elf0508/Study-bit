...
modelpath = './model/sample/breat_cancer/breat_cancer_checkpoint-{epoch:02d}-{val_loss:.4f}.hdf5'
...
# 저장
model.save('./model/sample/breat_cancer/breat_cancer_model_save.h5')     # 훈련아래

model.save_weights('./model/sample/breat_cancer/breat_cancer_model_save_weight.h5')  # 훈련아래
