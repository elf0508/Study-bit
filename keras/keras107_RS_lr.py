...
# def build_model(drop=0.5, optimizer = RMSprop, lr = 0.01):
# def build_model(drop=0.5, optimizer = SGD, lr = 0.01):
# def build_model(drop=0.5, optimizer = Adadelta, lr = 0.01):
# def build_model(drop=0.5, optimizer = Adagrad, lr = 0.01):
# def build_model(drop=0.5, optimizer = Nadam, lr = 0.01):
