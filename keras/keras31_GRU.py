...
# model.fit(x, y, epochs=200, batch_size=1) # [[7.8401113]]
# model.fit(x, y, epochs=400, batch_size=32) #  [[7.877857]]
# model.fit(x, y, epochs=950, batch_size=32)  # [[7.8947077]] 
model.fit(x, y, epochs=1300, batch_size=32)  #  [[7.885842]]
