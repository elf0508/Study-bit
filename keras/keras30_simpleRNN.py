...
model.fit(x, y, epochs=200, batch_size=32)  #  [[7.803577]]
model.fit(x, y, epochs=400, batch_size=32)  #  [[7.8583097]]
model.fit(x, y, epochs=950, batch_size=32)  #  [[7.8753457]]
model.fit(x, y, epochs=1500, batch_size=32)  # [[7.9048915]]
