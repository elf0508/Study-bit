...
for dirname, _, filenames in os.walk('../input/rsna-str-pulmonary-embolism-detection/'):
# for dirname, _, filenames in os.walk('/kaggle/input'):
# for dirname, _, filenames in os.walk('/kaggle/input/osic-pulmonary-fibrosis-progression/'):
...
basepath = "/kaggle/input/osic-pulmonary-fibrosis-progression/"
...
TEST_DIR = 'kaggle/OSIC_폐 섬유증 진행/test.csv'
TRAIN_CSV_PATH = 'kaggle/OSIC_폐 섬유증 진행/train.csv'
...
# train = pd.read_csv(basepath + "kaggle/OSIC_폐 섬유증 진행/train.csv")
# test = pd.read_csv(basepath + "kaggle/OSIC_폐 섬유증 진행/test.csv")


print("----- train.shape  ---------")
print("train.shape : ", train.shape)   #  (1549, 7)
