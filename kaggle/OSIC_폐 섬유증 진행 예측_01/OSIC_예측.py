...
TEST_DIR = 'kaggle/OSIC_폐 섬유증 진행 예측_01/test.csv'
TRAIN_CSV_PATH = 'kaggle/OSIC_폐 섬유증 진행 예측_01/train.csv'
...
train = pd.read_csv('kaggle/OSIC_폐 섬유증 진행 예측_01/train.csv')
test = pd.read_csv('kaggle/OSIC_폐 섬유증 진행 예측_01/test.csv')
...
sample = pd.read_csv('kaggle/OSIC_폐 섬유증 진행 예측_01/sample_submission.csv')
