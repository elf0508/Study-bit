...
predictor = dlib.shape_predictor('프로젝트_연습/얼굴인식 스노우 카메라/shape_predictor_68_face_landmarks (4).dat')

# load video
cap = cv2.VideoCapture('samples/girl.mp4')

# load overlay image
overlay = cv2.imread('프로젝트_연습/얼굴인식 스노우 카메라/face_detector-master/face_detector-master/samples/girl.mp4', cv2.IMREAD_UNCHANGED)
