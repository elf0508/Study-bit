...
model_01.compile(optimize = 'adam', loss = 'mse', metrics = ['acc'])
# model.compile(optimize = 'adam', loss = 'binary_crossentropy', metrics = ['acc'])
model_01.fit(x_train, x_train, epochs = 10)

model_02.compile(optimize = 'adam', loss = 'mse', metrics = ['acc'])
# model.compile(optimize = 'adam', loss = 'binary_crossentropy', metrics = ['acc'])
model_02.fit(x_train, x_train, epochs = 10)

model_04.compile(optimize = 'adam', loss = 'mse', metrics = ['acc'])
# model.compile(optimize = 'adam', loss = 'binary_crossentropy', metrics = ['acc'])
model_04.fit(x_train, x_train, epochs = 10)

model_08.compile(optimize = 'adam', loss = 'mse', metrics = ['acc'])
# model.compile(optimize = 'adam', loss = 'binary_crossentropy', metrics = ['acc'])
model_08.fit(x_train, x_train, epochs = 10)

model_16.compile(optimize = 'adam', loss = 'mse', metrics = ['acc'])
# model.compile(optimize = 'adam', loss = 'binary_crossentropy', metrics = ['acc'])
model_16.fit(x_train, x_train, epochs = 10)

model_32.compile(optimize = 'adam', loss = 'mse', metrics = ['acc'])
# model.compile(optimize = 'adam', loss = 'binary_crossentropy', metrics = ['acc'])
