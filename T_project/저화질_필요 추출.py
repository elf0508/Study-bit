...
# 전제에서 필요한 부분만 추출하는 코드
# 예: 전제 100에서  필요한 부분 45만 추출 하는 것
...
def search(dirname):
    ...
    # return np.save('D:/Study-bit/T_project/Low_Resolution/Image1.npy', arr=f)
    # return np.save('D:/Study-bit/T_project/Low_Resolution/Image2.npy', arr=f)
    # return np.save('D:/Study-bit/T_project/Low_Resolution/Image3.npy', arr=f)
    ...
    return np.save('D:/Study-bit/T_project/Low_Resolution/Image102.npy', arr=f)

    

# search('D:/Study-bit/T_project/Low_Resolution/19062421')
# search('D:/Study-bit/T_project/Low_Resolution/19062431')
# search('D:/Study-bit/T_project/Low_Resolution/19062521')
# search('D:/Study-bit/T_project/Low_Resolution/19062531')

search('D:/Study-bit/T_project/Low_Resolution/19072512')
